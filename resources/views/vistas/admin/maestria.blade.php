                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="miForm" method="post" action="{{ route('programa.crear') }}">
                                ...
                                <input type="hidden" class="form-control" id="nivelformacion" name="nivelformacion" value="MAESTRIA">
...
<script>
    ...
    $('#menuMaestria').addClass('activo');
    //$('#botonConfiguracion').removeClass('collapsed');
