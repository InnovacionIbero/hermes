    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow"
            ...
            <div class="input-group">
                <div class="input-group-append text-gray-800 text-center">
                    <h3><strong> Bienvenido {{ auth()->user()->nombre }}! - Prueba Filtros </strong></h3>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="text-center" id="mensaje">
                <h5>Esta pagina es para realizar la pruebas/ ajustes/ correcciones de los filtros </h5>
            </div>
            <br>

            <!-- incluimos los filtros  -->

            @include('layout.filtrosprueba')
       
            <!-- incluimos los gráficos-->
            {{-- @include('layout.graficosMoodle') --}}
