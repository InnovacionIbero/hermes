        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow"
            ...
            <div class="input-group">
                <div class="input-group-append text-gray-800">
                    <h3><strong> Bienvenido {{ auth()->user()->nombre }}! - Informe Proyección - Planeación </strong>
                    </h3>
                </div>
            </div>
        </nav>
                            ...
                            <div id="periodos">
                                ...
                                <div class="row mb-3">
                                    <div class="col-4">
                                        <!--Formación continua-->
                                        <div class="card">
                                            <div class="card-header fondocards" id="heading2"
                                                style="width:100%; cursor:pointer;" data-toggle="collapse"
                                                ...
                                                <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="checkbox-wrapper">
                                                        <label for="todosContinua" style="font-size:12px;">Selec.
                                                            Todos</label>
                                                        ...
                                                        <label class="cbx" for="todosContinua"><span>
                                                                ...
                                                                </svg></span><span style="display: none;">Selec.
                                                                Todos</span>
                                                        </label>
                                                    </div>
                                                </h5>
                                            </div>
                                            <div id="collapse2" class="collapse shadow" aria-labelledby="heading2"
                                                data-parent="#periodos">
                                    ...
                                    <div class="col-4">
                                        <!--Pregrado-->
                                        <div class="card">
                                            <div class="card-header fondocards" id="heading1"
                                                style="width:100%;cursor:pointer;" data-toggle="collapse"
                                                ...
                                                <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="checkbox-wrapper">
                                                        <label for="todosPregrado" style="font-size:12px;">Selec.
                                                            Todos</label>
                                                        <input class="inp-cbx" id="todosPregrado" type="checkbox"
                                                            checked>
                                            ...
                                            <div id="collapse1" class="collapse shadow" aria-labelledby="heading1"
                                                data-parent="#periodos">
                                                <div class="card-body periodos" style="width:100%;" id="Pregrado">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4 text-start">
                                        <div class="card mb-3" id="cardProgramas">
                                            <div class="card-header text-center fondocards" id="HeadingProgramas"
                                                style="width:100%; cursor:pointer;" data-toggle="collapse"
                                                data-target="#acordionProgramas" aria-expanded="false"
                                                aria-controls="acordionProgramas">
                                                <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                                    <button class="btn btn-link text-light">
                                                        Programas
                                                    </button>
                                                    ...
                                                    <div class="checkbox-wrapper">
                                                        <label for="todosPrograma" style="font-size:12px;">Selec.
                                                            Todos</label>
                                                        <input class="inp-cbx" id="todosPrograma" type="checkbox"
                                                            checked>
                                            ...
                                            <div class="card-body text-start collapse shadow" id="acordionProgramas"
                                                aria-labelledby="headingProgramas" style="overflow: auto;">
                                                <div name="programas">
                                                    <input type="text" class="form-control mb-2"
                                                        id="buscadorProgramas" placeholder="Buscar programas">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <!--Especialización-->
                                        <div class="card">
                                            <div class="card-header fondocards" id="heading3"
                                                style="width:100%; cursor:pointer;" data-toggle="collapse"
                                                ...
                                                <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="checkbox-wrapper">
                                                        <label for="todosEsp" style="font-size:12px;">Selec.
                                                            Todos</label>
                                                        <input class="inp-cbx" id="todosEsp" type="checkbox"
                                                            checked>
                                            ...
                                            <div id="collapse3" class="collapse shadow" aria-labelledby="heading3"
                                                data-parent="#periodos">
                                    ...
                                    <div class="col-4">
                                        <!--Maestría-->
                                        <div class="card">
                                            <div class="card-header fondocards" id="heading4"
                                                style="width:100%; cursor:pointer;" data-toggle="collapse"
                                                ...
                                                <h5 class="mb-0 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="checkbox-wrapper">
                                                        <label for="todosMaestria" style="font-size:12px;">Selec.
                                                            Todos</label>
                                                        <input class="inp-cbx" id="todosMaestria" type="checkbox"
                                                            checked>
                                            ...
                                            <div id="collapse4" class="collapse shadow" aria-labelledby="heading4"
                                                data-parent="#periodos">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 text-right">
                                    <span data-toggle="tooltip"
                                        title="Muestra la cantidad de alertas activas por programa"
  ...
  <script>
        $(document).ready(function() {
            ...
            function getPeriodos() {
                var periodosSeleccionados = [];
                var checkboxesSeleccionados = $('#Continua, #Pregrado, #Esp, #Maestria').find(
            ...
            $('#generarReporte').on('click', function(e) {
                ...
                if (periodosSeleccionados.length > 0) {
                    if ($('#programas input[type="checkbox"]:checked').length > 0 && $(
                            '#programas input[type="checkbox"]:checked').length < totalProgramas) {
            ...
            function graficoAlertas() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (chartAlertas.data.labels.length == 0 && chartAlertas.data.datasets[0].data
                            .length == 0) {
                        ...
                        if (data.length > 0) {
                            ...
                            function obtener_data_inactivar(tbody, table) {
                                $(tbody).on("click", "button.inactivar", function(event) {
                                    ...
                                    if (data.activo == 1) {
                                        Swal.fire({
                                            title: "¿Ya se ha resuelto la alerta temprana " +
                                                data.desccripcion + "?",
                                            icon: 'warning',
