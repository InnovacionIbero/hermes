  ...
  //var_dump( $tablaConsulta);
    ...
    public function traerProgramas()
    {
        ...
        if(count($Facultades) === 1 && $Facultades[0] === ""){
            ...
            $Facultades = DB::table('facultad')->select('nombre')->whereIn('id',$facts)->pluck('nombre')->toArray();
        }
        ...
        if($tabla == 'Mafi'){
            ...
            $programas = [];
            //--- periodos activos en moodle
            $consultaProgramas = DB::connection('sqlsrv')->table('V_Reporte_Ausentismo')->select('Grupo')
